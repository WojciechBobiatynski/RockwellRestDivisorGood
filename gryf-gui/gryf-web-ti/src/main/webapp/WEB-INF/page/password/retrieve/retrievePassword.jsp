...
<!DOCTYPE html>
<html prefix="og: http://ogp.me/ns#" lang="pl" itemtype="http://schema.org/WebPage" itemscope class="gryf-web-ti retrievepassword">
        ...
        <section class="form form-big">
            ...
            <div class="content">
                ...
                <form name="verificationForm" action="${pageContext.request.contextPath}/retrieve/password" method="POST">
                    ...
                    <div class="field field-string required">
                        <div class="label">
