...
<!DOCTYPE html>
<html prefix="og: http://ogp.me/ns#" lang="pl" itemtype="http://schema.org/WebPage" itemscope class="gryf-web-ti resetexception">
...
<div id="content" class="page-login"><div class="grid">
    <section class="form form-big form-login">
        <div class="content">
            <h3 itemprop="headline name" class="headline name">Tworzenie nowego hasła</h3>
