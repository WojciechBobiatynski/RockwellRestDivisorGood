...
<!DOCTYPE html>
<html prefix="og: http://ogp.me/ns#" lang="pl" itemtype="http://schema.org/WebPage" itemscope class="gryf-web-ind sendvercodesuccess">
...
<body id="ak">
    ...
    <div id="content" class="page-login"><div class="grid">
        ...
        <section class="form form-big form-login">
            <div class="content">
                <p itemprop="description" class="description">Wiadomość email została wysłana pomyślnie.</p>
