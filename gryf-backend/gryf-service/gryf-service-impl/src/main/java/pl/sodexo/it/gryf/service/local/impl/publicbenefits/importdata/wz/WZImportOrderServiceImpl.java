 ...
 */
@Service(value = ImportDataService.WZ_IMPORT_ORDER_SERVICE)
public class WZImportOrderServiceImpl extends ImportBaseDataServiceImpl {
    ...
    protected ImportResultDTO saveInternalNormalData(ImportParamsDTO paramsDTO, Row row, Long importJobId) {
        ...
        validateContractId(paramsDTO, importOrderDTO.getExternalOrderId());
    ...
    private void validateContractId(ImportParamsDTO paramsDTO, String externalOrderId) {
        orderValidator.validateContractIdAgreementWithPattern(paramsDTO.getGrantProgram(), externalOrderId, externalOrderIdPatternRegexp);
    }
