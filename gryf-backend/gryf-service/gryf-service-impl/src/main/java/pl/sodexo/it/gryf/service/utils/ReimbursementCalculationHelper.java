...
public final class ReimbursementCalculationHelper {
    ...
    /**
     * Wylicza wartość godziny usługi rozliczana bonami
    ...
    public static BigDecimal calculateVoucherRefundedTrainingHourValue(ReimbursementTraining t){
        ...
        BigDecimal cbgs = GryfUtils.getValue(t.getTrainingHourGrossPrice()); //Cena brutto godziny usługi
        return wprod.min(cbgs);//min (wprod, cbgs)
    }

    /**
     * Wylicza kwotę należną IS od Sodexo
     * @param t linia usługi
     * @param voucherRefundedTrainingHourValue wartość godziny usługi rozliczana bonami
    ...
    public static BigDecimal calculateSxoTiAmountDue(ReimbursementTraining t, BigDecimal voucherRefundedTrainingHourValue){
        ...
        BigDecimal wgsrb = GryfUtils.getValue(voucherRefundedTrainingHourValue);//Wartość godziny usługi rozliczana bonami
    ...
    public static BigDecimal calculateEntToTiAmountDue(ReimbursementTraining t, BigDecimal sxoTiAmountDue){
        BigDecimal cbgs = GryfUtils.getValue(t.getTrainingHourGrossPrice()); //Cena brutto godziny usługi
        BigDecimal ig = GryfUtils.getValue(t.getTrainingHoursTotal());//ilość godzin (usługi)
    ...
    /**
     * Wylicza całkowity koszt usługi
     * @param t linia usługi
     * @return wyliczona wartość
     */
    ...
    /**
     * Wylicza kwotę nalezną IS do MSP. Sumuje pola ze usług.
     * @param r rozliczenie
     * @return wyliczona wartość
     */
    ...
    /**
     * Wylicza wykorzystany wkład własny MSP. Sumuje pola ze usług.
     * @param r rozliczenie
     * @return wyliczona wartość
     */
    ...
    /**
     * Wylicza wartość dofinansowania MSP. Sumuje pola ze usług.
     * @param r rozliczenie
     * @return wyliczona wartość
     */
    ...
    /**
     * Wylicza wartosć dofinansowania wpłąconego do IS. Sumuje pola ze usług.
     * @param r rozliczenie
     * @return wyliczona wartość
     */
    ...
    /**
     * Wylicza ałkowity koszt usług. Sumuje pola ze usług.
     * @param r rozliczenie
     * @return wyliczona wartość
     */
    ...
    /**
     * Sumuje całkowity koszt treningów: Suma (Ilość godzin usługi wszystkich uczestników *
     * Cena brutto godziny usługi) dla wszystkich usług. Nie liczy na podstawie danych wylicoznych wczesniej lecz na podstyawie prowadzonych danych w dto.
     * Metoda wykorzystywana przy sprawdzeniu czy  Suma (Ilość godzin usługi wszystkich uczestników *
     * Cena brutto godziny usługi) dla wszystkich usług = kwota brutto faktury
