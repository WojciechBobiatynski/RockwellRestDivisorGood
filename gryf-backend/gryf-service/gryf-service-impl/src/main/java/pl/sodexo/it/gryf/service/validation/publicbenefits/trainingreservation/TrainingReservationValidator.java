...
public class TrainingReservationValidator {
    ...
    public void validateAuthorizationData(Individual individual, String verificationCode) {
        String verificationCodeSaved = AEScryptographer.decrypt(individual.getIndividualUser().getVerificationCode());
        if(!verificationCodeSaved.equals(verificationCode)) {
            throw new GryfIndUserVerificationException("Podany kod weryfikacyjny jest niepoprawny");
        }
    }
