...
insert into APP_PBE.PBE_PRODUCT_INSTANCE_E (ID, PRD_ID, NUM, TYPE_ID, SOURCE_ID, VERSION, CREATED_USER, CREATED_TIMESTAMP, MODIFIED_USER, MODIFIED_TIMESTAMP)
  select  eagle.pk_seq.nextval, 'KK_BON_ELE', NUM, 'EMISSION', PRODUCT_EMISSION_ID, 1, 'EAGLE', SYSDATE, 'EAGLE', SYSDATE
...
insert into APP_PBE.TI_TRAINING_INSTANCES (ID, TRAINING_ID, INDIVIDUAL_ID, GRANT_PROGRAM_ID, STATUS_ID, ASSIGNED_NUM, REGISTER_DATE, REIMBURSMENT_PIN, OPINION_DONE, VERSION, CREATED_USER, CREATED_TIMESTAMP, MODIFIED_USER, MODIFIED_TIMESTAMP)
values (1, 1, 2, 100, 'RES', 10, SYSDATE, null, 'N', 1, 'EAGLE', SYSDATE, 'EAGLE', SYSDATE);
insert into APP_PBE.TI_TRAINING_INSTANCES (ID, TRAINING_ID, INDIVIDUAL_ID, GRANT_PROGRAM_ID, STATUS_ID, ASSIGNED_NUM, REGISTER_DATE, REIMBURSMENT_PIN, OPINION_DONE, VERSION, CREATED_USER, CREATED_TIMESTAMP, MODIFIED_USER, MODIFIED_TIMESTAMP)
values (2, 1, 2, 100, 'DONE', 20, SYSDATE, null, 'N', 1, 'EAGLE', SYSDATE, 'EAGLE', SYSDATE);
insert into APP_PBE.TI_TRAINING_INSTANCES (ID, TRAINING_ID, INDIVIDUAL_ID, GRANT_PROGRAM_ID, STATUS_ID, ASSIGNED_NUM, REGISTER_DATE, REIMBURSMENT_PIN, OPINION_DONE, VERSION, CREATED_USER, CREATED_TIMESTAMP, MODIFIED_USER, MODIFIED_TIMESTAMP)
values (3, 1, 2, 100, 'REIMB', 30, SYSDATE, null, 'N', 1, 'EAGLE', SYSDATE, 'EAGLE', SYSDATE);
