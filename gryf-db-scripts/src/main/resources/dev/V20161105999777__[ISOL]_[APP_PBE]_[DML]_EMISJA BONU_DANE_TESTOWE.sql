...
values (2, 'ACTIVE', to_date('17/09/26','RR/MM/DD'), 60, 50, 10, 0, 0, 2, 1270, 'KK_BON_ELE', 1, 'EAGLE', SYSDATE, 'EAGLE', SYSDATE);
insert into APP_PBE.PBE_PRODUCT_INSTANCE_POOLS (ID, STATUS_ID, EXPIRY_DATE, All_NUM, AVAILABLE_NUM, RESERVED_NUM, USED_NUM, REMBURS_NUM,
INDIVIDUAL_ID, ORDER_ID, PRD_ID, VERSION, CREATED_USER, CREATED_TIMESTAMP, MODIFIED_USER, MODIFIED_TIMESTAMP)
values (3, 'ACTIVE', to_date('18/09/26','RR/MM/DD'), 80, 80, 0, 0, 0, 2, 1271, 'KK_BON_ELE', 1, 'EAGLE', SYSDATE, 'EAGLE', SYSDATE);
