...
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.USED                       IS 'Czy wpis zosta� u�yty do oznaczenia p�atno�ci na docelowym obiekcie (zam�wieniu/Zadaniu/Zam�wieniu PB';
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.ORDER_ID                   IS 'Id Zam�wienia / Zadania / Zam�wienia PB';
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.SOURCE_TYPE                IS 'Typ �r�d�a identyfikatora w polu ORD_ID
...
ORDPB - Zam�wienia PB';
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.DOC_NUMBER                 IS 'Identyfikator dokumentu, po kt�rym nast�pi�o zmatchowanie p�atno�ci. Dla zam�wie�, zada�, propozycji faktury jest to numer proformy. Dla zam�wie� PB jest to zewn�trzny numer zam�wienia nadawany przez WUP';
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.AMOUNT                     IS 'Warto�� podpi�ta do zam�wienia';
...
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.MATCH_DATE                 IS 'Data podpi�cia p�atno�ci w Eagle';
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.MATCH_DATE_NAV             IS 'Data podpi�cia p�atno�ci w Navision';
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.PAYMENT_DATE               IS 'Data p�atno�ci';
...
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.ERROR_TIMESTAMP            IS 'B��d podpi�cia p�atno�ci - data';
COMMENT ON COLUMN APP_FIN.NAV_MC_TRANSFERS_PRC.ERROR_MESSAGE              IS 'B��d podpi�cia p�atno�ci - opis';
