-----------------------------------------------------
----- APP_PBE.TI_TRAINING_CATEGORY_PAR_AUDIT --------
-----------------------------------------------------
ALTER TABLE APP_PBE.TI_TRAINING_CATEGORY_PAR_AUDIT
 ADD (MAX_PARTICIPANTS  NUMBER(10));

ALTER TABLE APP_PBE.TI_TRAINING_CATEGORY_PAR_AUDIT
RENAME COLUMN INDIVIDUAL_PRODUCT_INSTANCE TO MIN_PARTICIPANTS;

CREATE OR REPLACE TRIGGER APP_PBE.TRG_TI_TRAINING_CATEG_PAR_AUD
AFTER DELETE OR UPDATE ON app_pbe.TI_TRAINING_CATEGORY_PARAMS
...
BEGIN 
 IF DELETING THEN v_operation := 'D'; END IF;
  INSERT INTO app_pbe.TI_TRAINING_CATEGORY_PAR_AUDIT ( 
    ID,
    CATEGORY_ID,
    GRANT_PROGRAM_ID,
