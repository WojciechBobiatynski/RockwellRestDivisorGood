...
(
  ...
  SXO_TI_AMOUNT_DUE_TOTAL NUMBER, -- Ca�kowita kwota od Operatora Finansowego dla Usługodawcy
  SXO_IND_AMOUNT_DUE_TOTAL NUMBER, -- Kwota nadp�aty wk�adu w�asnego u�ytkownika - zwrot od OF
  IND_TI_AMOUNT_DUE_TOTAL NUMBER, -- Ca�kowtia kwota od U�ytkownika dla Usługodawcy
  ...
  TI_REIMB_ACCOUNT_NUMBER VARCHAR(26), -- Numer konta Usługodawcy do zwrotu
...
COMMENT ON COLUMN APP_PBE.E_REIMBURSEMENTS.PRODUCT_INSTANCE_POOL_ID IS 'Rozliczana p�la bon�w.Klucz obcy do PRODUCT_INSTANCE_POOLS';
...
COMMENT ON COLUMN APP_PBE.E_REIMBURSEMENTS.SXO_TI_AMOUNT_DUE_TOTAL IS 'Ca�kowita kwota od Operatora Finansowego dla Usługodawcy';
...
COMMENT ON COLUMN APP_PBE.E_REIMBURSEMENTS.IND_TI_AMOUNT_DUE_TOTAL IS 'Ca�kowtia kwota od U�ytkownika dla Usługodawcy';
...
COMMENT ON COLUMN APP_PBE.E_REIMBURSEMENTS.TI_REIMB_ACCOUNT_NUMBER IS 'Numer konta Usługodawcy do zwrotu';
