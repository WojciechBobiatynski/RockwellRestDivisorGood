...
-- Komentarze
COMMENT ON TABLE APP_PBE.EMPLOYMENTS IS '@Author(Adam Kmieci�ski); @Project(Gryf-PBE); @Date(2016-10-28) ;@Purpose(Tabela reprezentuj�ca powi�zania pomi�dzy M�P a Osob� fizyczn�);';
...
COMMENT ON COLUMN APP_PBE.EMPLOYMENTS.ENT_ID IS 'ID Usługodawcy';
COMMENT ON COLUMN APP_PBE.EMPLOYMENTS.VERSION IS 'Wersja. Kolumna techniczna u�ywana do mechanizmu Optimistic Lock';
COMMENT ON COLUMN APP_PBE.EMPLOYMENTS.CREATED_USER IS 'Login u�ytkownika, kt�ry utworzy� rekord';
COMMENT ON COLUMN APP_PBE.EMPLOYMENTS.CREATED_TIMESTAMP IS 'Data utworzenia rekordu';
COMMENT ON COLUMN APP_PBE.EMPLOYMENTS.MODIFIED_USER IS 'Login u�ytkownika, kt�ry ostatnio modyfikowa� rekord';
