...
(
	...
	CRC NUMBER(10),
	PRODUCT_EMISSION_ID VARCHAR2(20),
	ORDER_ID NUMBER,
...
ALTER TABLE APP_PBE.PBE_PRODUCT_INSTANCES ADD CONSTRAINT ORDERS_FK FOREIGN KEY (ORDER_ID) REFERENCES APP_PBE.ORDERS (ID);
...
--ALTER TABLE APP_PBE.PBE_PRODUCT_INSTANCES ADD CONSTRAINT REIMBURSEMENTS_FK FOREIGN KEY (E_REIMBURSMENT_ID) REFERENCES APP_PBE.E_REIMBURSEMENTS (ID);
...
COMMENT ON COLUMN APP_PBE.PBE_PRODUCT_INSTANCES.ORDER_ID IS 'ID zamówienia';
COMMENT ON COLUMN APP_PBE.PBE_PRODUCT_INSTANCES.PRODUCT_EMISSION_ID IS 'ID emisji produktu';
COMMENT ON COLUMN APP_PBE.PBE_PRODUCT_INSTANCES.E_REIMBURSMENT_ID IS 'ID rozliczenia';
