...
-- Komentarze
COMMENT ON TABLE APP_PBE.TI_USER_RESET_ATTEMPTS IS '@Author(Adam Kmieci�ski); @Project(Gryf-PBE); @Date(2016-10-25) ;@Purpose(Tabel reprezentuj�ca zdarzenia ��dania zresetowania has�a dla Usługodawcy);';
...
COMMENT ON COLUMN APP_PBE.TI_USER_RESET_ATTEMPTS.TIU_ID IS 'ID Usługodawcy';
