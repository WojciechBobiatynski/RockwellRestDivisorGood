...
--Indeksy
CREATE UNIQUE INDEX APP_PBE.TI_TRA_INS_REIM_UNIQ_IDX ON APP_PBE.TI_TRAINING_INSTANCES (E_REIMBURSMENT_ID);
...
--ALTER TABLE APP_PBE.PBE_PRODUCT_INSTANCE_POOL_USES ADD CONSTRAINT PBE_PRD_INS_POL_USE_EREIM_FK FOREIGN KEY (E_REIMBURSMENT_ID) REFERENCES APP_PBE.E_REIMBURSEMENTS (ID);
...
COMMENT ON COLUMN APP_PBE.TI_TRAINING_INSTANCES.E_REIMBURSMENT_ID IS 'ID rozliczenia';
