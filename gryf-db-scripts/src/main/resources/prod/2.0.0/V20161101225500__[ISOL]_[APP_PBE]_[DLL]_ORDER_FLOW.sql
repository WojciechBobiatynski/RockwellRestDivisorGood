...
Insert into APP_PBE.ORDER_FLOW_STATUS_TRANSITIONS (ORDER_FLOW_ID,STATUS_ID,ACTION_ID,ACTION_NAME,ACTION_DESCRIPTION,ACTION_CLASS,NEXT_STATUS_ID,AUG_ID_REQUIRED, AUTOMATIC) values (100,'DOCGENKK',10034, 'Drukuj dokumenty','Akcja generuje niezbêdne dokumenty ksiêgowe','careerDirectionGenerateDocuments','PROCESSDKK','GRF_PBE_ORDERS_PRINT_DOC', 'Y');
...
Insert into APP_PBE.ORDER_FLOW_STATUS_TRANSITIONS (ORDER_FLOW_ID,STATUS_ID,ACTION_ID,ACTION_NAME,ACTION_DESCRIPTION,ACTION_CLASS,NEXT_STATUS_ID,AUG_ID_REQUIRED, AUTOMATIC) values (100,'NEWKK',10015,'Anuluj','Akcja anuluje zamówienie',null,'CANCELLDKK','GRF_PBE_ORDERS_CANCEL', 'N');
Insert into APP_PBE.ORDER_FLOW_STATUS_TRANSITIONS (ORDER_FLOW_ID,STATUS_ID,ACTION_ID,ACTION_NAME,ACTION_DESCRIPTION,ACTION_CLASS,NEXT_STATUS_ID,AUG_ID_REQUIRED, AUTOMATIC) values (100,'PAIDKK',10025,'Anuluj','Akcja anuluje zamówienie',null,'CANCELLDKK','GRF_PBE_ORDERS_CANCEL', 'N');
...
Insert into APP_PBE.ORDER_FLOW_ELEMENT_TYPES (ID,DESCRIPTION,COMPONENT_NAME) values ('C_ORDADR','Element z³o¿ony reprezentuj¹cy podstawowe dane o adresach zamówienia. Front: html i JS, Backend: serwisy, DTOsy do obs³ugi elementu z³o¿onego powo³ywane s¹ dynamicznie na podstawie nazwy przechowywanej w kolumnie COMPONENT_NAME','ComplexTypeAddressInfo');
...
Insert into APP_PBE.ORDER_FLOW_ELEMENTS (ELEMENT_ID,ELEMENT_NAME,ELEMENT_TYPE_ID,ELEMENT_TYPE_PARAMS,ELEMENT_DESCRIPTION) values ('ORDADR_KK','Informacje o adresach','C_ORDADR',null,'Element z³o¿ony przetrzymuj¹cy podstawowe informacje adresach');
...
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('NEWKK',       'ORDADR_KK',15, 'IUM', null,null);
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('PAIDKK',      'ORDADR_KK',15, null, null,null);
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('DOCGENKK',    'ORDADR_KK',15, null, null,null);
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('PROCESSDKK',  'ORDADR_KK',15, null, null,null);
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('SENTKK',      'ORDADR_KK',15, null, null,null);
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('EKSPORTKK',   'ORDADR_KK',15, null, null,null);
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('CANCELLDKK',  'ORDADR_KK',15, null, null,null);
