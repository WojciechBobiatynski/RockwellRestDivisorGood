...
Insert into APP_PBE.ORDER_FLOW_STATUS_TRANSITIONS (ORDER_FLOW_ID,STATUS_ID,ACTION_ID,ACTION_NAME,ACTION_DESCRIPTION,ACTION_CLASS,NEXT_STATUS_ID,AUG_ID_REQUIRED, AUTOMATIC) values (100,'NEWKK',10015,'Anuluj','Akcja anuluje zamówienie',null,'CANCELLDKK',null, 'Y');
Insert into APP_PBE.ORDER_FLOW_STATUS_TRANSITIONS (ORDER_FLOW_ID,STATUS_ID,ACTION_ID,ACTION_NAME,ACTION_DESCRIPTION,ACTION_CLASS,NEXT_STATUS_ID,AUG_ID_REQUIRED, AUTOMATIC) values (100,'PAIDKK',10025,'Anuluj','Akcja anuluje zamówienie',null,'CANCELLDKK',null, 'Y');
...
Insert into APP_PBE.ORDER_FLOW_ELEMENTS (ELEMENT_ID,ELEMENT_NAME,ELEMENT_TYPE_ID,ELEMENT_TYPE_PARAMS,ELEMENT_DESCRIPTION) values ('DOWNDIS_KK','Nota obcia¿eniowo-ksiêgowa na wk³¹d wasny','ATTACHMENT',null,'Element reprezentuj¹cy wygenerowan¹ notê obcia¿eniowo-ksiêgow¹ na wkad wasny - pole uzupe³niane automatycznie');
Insert into APP_PBE.ORDER_FLOW_ELEMENTS (ELEMENT_ID,ELEMENT_NAME,ELEMENT_TYPE_ID,ELEMENT_TYPE_PARAMS,ELEMENT_DESCRIPTION) values ('ATTAC01_KK','Nota obcia¿eniowo-ksiêgowa na wk³¹d wasny (gdy inna ni¿ wygenerowana)','ATTACHMENT',null,'Element reprezentuj¹cy notê obcia¿eniowo-ksiêgow¹ na wkad wasny wysylan¹ do u¿ytkownika');
...
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('DOCGENKK',    'ADRCOR_KK',11, null, null,null);
...
Insert into APP_PBE.ORDER_FLOW_ELEMENTS_IN_STATUS (STATUS_ID,ELEMENT_ID,POS,FLAGS,AUG_ID_REQUIRED,ALLOWED_DELAY_TYPE_ID) values ('EKSPORTKK',   'ADRCOR_KK',11, null, null,null);
