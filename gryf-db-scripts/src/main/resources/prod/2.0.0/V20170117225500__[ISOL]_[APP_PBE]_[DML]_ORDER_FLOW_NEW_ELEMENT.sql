Insert into APP_PBE.ORDER_FLOW_ELEMENTS (ELEMENT_ID,ELEMENT_NAME,ELEMENT_TYPE_ID,ELEMENT_TYPE_PARAMS,ELEMENT_DESCRIPTION) values ('WDEPNUM_KK','Nota przysz³ych nale¿noœci WUP','ATTR_V','MAX_LENGTH=50; ','Dodatkowy numer dokumentu');
