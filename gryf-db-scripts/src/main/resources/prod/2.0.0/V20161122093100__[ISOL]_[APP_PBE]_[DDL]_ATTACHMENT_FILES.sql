...
(
	...
	STATUS VARCHAR2(10) NOT NULL,    -- Status pliku (TO_DELETE, SAVED, CORRECT)
...
COMMENT ON COLUMN APP_PBE.ATTACHMENT_FILES.STATUS IS 'Status pliku (TO_DELETE, SAVED, CORRECT)';
