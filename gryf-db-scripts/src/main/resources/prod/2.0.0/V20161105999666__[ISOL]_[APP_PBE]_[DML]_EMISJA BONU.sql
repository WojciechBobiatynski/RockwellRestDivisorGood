...
insert into APP_PBE.PBE_PRODUCT_INSTANCE_STATUSES (ID, NAME, ORDINAL) values ('RES', 'Zarezerwowany', 2);
insert into APP_PBE.PBE_PRODUCT_INSTANCE_STATUSES (ID, NAME, ORDINAL) values ('USE', 'Wykorzystany', 3);
insert into APP_PBE.PBE_PRODUCT_INSTANCE_STATUSES (ID, NAME, ORDINAL) values ('REIMB', 'Rozliczony', 4);
