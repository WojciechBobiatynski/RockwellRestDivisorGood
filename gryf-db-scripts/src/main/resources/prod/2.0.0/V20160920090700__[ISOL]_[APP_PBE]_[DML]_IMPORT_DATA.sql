...
COMMENT ON COLUMN APP_PBE.ASYNCH_JOBS.START_TIMESTAMP IS 'Data rozpoczêcia zadania';
COMMENT ON COLUMN APP_PBE.ASYNCH_JOBS.STOP_TIMESTAMP IS 'Data zakoñczenia zadania';
...
(
  ...
  ORDER_ID NUMBER,
  TRAINING_INSTITUTION_ID NUMBER,
  TRAINING_ID NUMBER,
...
-- Klucze obce
ALTER TABLE APP_PBE.IMPORT_DATA_ROWS ADD CONSTRAINT IMP_DATA_ROWS_ASYN_JOB_FK FOREIGN KEY (IMPORT_JOB_ID) REFERENCES APP_PBE.ASYNCH_JOBS (ID);
...
COMMENT ON COLUMN APP_PBE.IMPORT_DATA_ROWS.CONTRACT_ID IS 'Idnetyfikator tworzonej umowy';
COMMENT ON COLUMN APP_PBE.IMPORT_DATA_ROWS.INDIVIDUAL_ID IS 'Identyfikato tworzonego u¿ytkownika';
COMMENT ON COLUMN APP_PBE.IMPORT_DATA_ROWS.ENTERPRISE_ID IS 'Identyfikator tworzonego MŒP';
COMMENT ON COLUMN APP_PBE.IMPORT_DATA_ROWS.ORDER_ID IS 'Identyfikator tworzonego zamówienia';
COMMENT ON COLUMN APP_PBE.IMPORT_DATA_ROWS.TRAINING_INSTITUTION_ID IS 'Identyfikator tworzonej/zmienianej isntytucji szkoleniowej';
COMMENT ON COLUMN APP_PBE.IMPORT_DATA_ROWS.TRAINING_ID IS 'Identyfikator tworzonego/zmienianego szkolenia';
COMMENT ON COLUMN APP_PBE.IMPORT_DATA_ROWS.TRAINING_INSTANCE_ID IS 'Identyfikator tworzonej/zmienianej instancji szkolenia';
