...
-- Komentarze
COMMENT ON TABLE APP_PBE.TRAINING_INSTITUTION_USERS IS '@Author(Jakub.Bentyn); @Project(Gryf-PBE); @Date(2016-10-05) ;@Purpose(Tabela przechowuj�ca u�ytkownik�w IS);';
...
COMMENT ON COLUMN APP_PBE.TRAINING_INSTITUTION_USERS.TRAINING_ISTITUTION_ID IS 'ID Usługodawcy u�ytkownika.';
...
COMMENT ON COLUMN APP_PBE.TRAINING_INSTITUTION_USERS.PASSWORD_EXP_DATE IS 'Data wyga�ni�cia has�a';
...
COMMENT ON COLUMN APP_PBE.TRAINING_INSTITUTION_USERS.CREATED_USER IS 'Login u�ytkownika, kt�ry utworzy� rekord'; 
COMMENT ON COLUMN APP_PBE.TRAINING_INSTITUTION_USERS.CREATED_TIMESTAMP IS 'Data utworzenia rekordu'; 
COMMENT ON COLUMN APP_PBE.TRAINING_INSTITUTION_USERS.MODIFIED_USER IS 'Login u�ytkownika, kt�ry ostatnio modyfikowa� rekord'; 
...
-- Komentarze
COMMENT ON TABLE APP_PBE.TE_ROLES IS '@Author(Jakub.Bentyn); @Project(Gryf-PBE); @Date(2016-10-05) ;@Purpose(Tabela przechowuj�ca role u�ytkownik�w IS);';

COMMENT ON COLUMN APP_PBE.TE_ROLES.CODE IS 'Nazwa roli';  
COMMENT ON COLUMN APP_PBE.TE_ROLES.DESCRIPTION IS 'Opis roli'; 
COMMENT ON COLUMN APP_PBE.TE_ROLES.CONTEXT IS 'Kontekst w jakim u�ywana jest rola. TI - kontekst Usługodawcy';
----------------------------
--TE_PRIVILEGES
----------------------------
...
--komentarze
COMMENT ON TABLE APP_PBE.TE_PRIVILEGES IS '@Author(Jakub.Bentyn); @Project(Gryf-PBE); @Date(2016-10-05) ;@Purpose(Tabela przechowuj�ca uprawnienia bezpiecze�stwa uzytkownik�w IS);';

COMMENT ON COLUMN APP_PBE.TE_PRIVILEGES.CODE IS 'Nazwa uprawnienia bezpiecze�stwa'; 
COMMENT ON COLUMN APP_PBE.TE_PRIVILEGES.DESCRIPTION IS 'Opis uprawnienia';
COMMENT ON COLUMN APP_PBE.TE_PRIVILEGES.CONTEXT IS 'Kontekst w jakim u�ywana jest przywilej. TI - kontekst Usługodawcy';
...
--komentarze
COMMENT ON TABLE APP_PBE.TI_USER_IN_ROLES IS '@Author(Jakub.Bentyn); @Project(Gryf-PBE); @Date(2016-10-05) ;@Purpose(Tabela z�aczeniowa r�l i  uzytkownik�w IS);';

COMMENT ON COLUMN APP_PBE.TI_USER_IN_ROLES.TI_USER_ID	IS 'Id uzytkownika IS';	
COMMENT ON COLUMN APP_PBE.TI_USER_IN_ROLES.TE_ROLE_CODE	IS 'Kod roli bezpiecze�stwa aplikacji IS';	
...
--komentarze
COMMENT ON TABLE APP_PBE.TE_PRIV_IN_ROLES IS '@Author(Jakub.Bentyn); @Project(Gryf-PBE); @Date(2016-10-05) ;@Purpose(Tabela z�aczeniowa r�l i uprawnie� bezpiecz�stwa w aplikacji IS);';
