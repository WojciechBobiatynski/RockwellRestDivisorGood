...
(
	...
	EXPIRED_NUM NUMBER(10) NOT NULL,
...
COMMENT ON COLUMN APP_PBE.PBE_PRODUCT_INSTANCE_POOLS.START_DATE IS 'Data pocz¹tku obowi¹zywania puli bonów';
COMMENT ON COLUMN APP_PBE.PBE_PRODUCT_INSTANCE_POOLS.EXPIRY_DATE IS 'Data wygaœniêcia puli bonów';
...
COMMENT ON COLUMN APP_PBE.PBE_PRODUCT_INSTANCE_POOLS.EXPIRED_NUM IS 'Iloœæ wygaœniêtych bonów';
