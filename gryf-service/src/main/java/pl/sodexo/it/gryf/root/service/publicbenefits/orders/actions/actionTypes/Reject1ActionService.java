...
import pl.sodexo.it.gryf.root.repository.publicbenefits.grantapplications.GrantApplicationStatusRepository;
...
public class Reject1ActionService extends ActionBaseService {
    ...
    protected void executeAction(Order order){
        ...
        MailService.MailPlaceholders mailPlaceholders = mailService.createPlaceholders("rejectionReason", oeReason.getValueVarchar())
