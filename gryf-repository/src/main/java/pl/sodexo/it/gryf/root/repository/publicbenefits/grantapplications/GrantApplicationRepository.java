...
import static pl.sodexo.it.gryf.model.publicbenefits.grantapplications.GrantApplicationBasicData.ADDRESS_INVOICE_ATTR_NAME;
import static pl.sodexo.it.gryf.model.publicbenefits.grantapplications.GrantApplicationBasicData.VAT_REG_NUM_ATTR_NAME;
import static pl.sodexo.it.gryf.model.publicbenefits.grantapplications.GrantApplicationBasicData.ZIP_CODE_INVOICE_ATTR_NAME;
/**
 * Created by tomasz.bilski.ext on 2015-06-30.
 */
@Repository
public class GrantApplicationRepository extends GenericRepository<GrantApplication, Long> {
